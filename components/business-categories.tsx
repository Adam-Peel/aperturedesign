...
import Logo02 from "@/public/images/psql.svg";
import Logo03 from "@/public/images/logo-03.svg";
import Logo04 from "@/public/images/react.svg";
import Logo05 from "@/public/images/logo-05.svg";
import Logo06 from "@/public/images/krystal.svg";
import Logo07 from "@/public/images/js.svg";
import Logo08 from "@/public/images/git.svg";
import Logo09 from "@/public/images/brave.svg";

export default function BusinessCategories() {
  return (
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 mt-20" id="tech">
        <div className="pb-12 md:pb-20">
          {/* Tab panels */}
          <div className="text-center">
            <p className="text-2xl font-bold text-gray-900">
              We use trusted digital products, and bring them together to meet
              your needs.
            </p>
          </div>
