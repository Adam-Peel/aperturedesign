...
import PlanetTagImg05 from "@/public/images/planet-tag-05.png";
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Our hosting providers operate with CDNs to ensure your site is
              always served quickly, no matter where it is being accessed from.
            </h2>
          </div>
          {/* Planet */}
            ...
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-linear-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-blue-500),transparent)]">
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  <div>
                    <Image
                      className="absolute -left-56 top-16 z-10 animate-[float_4s_ease-in-out_infinite_both] opacity-80 transition-opacity duration-500"
                      src={PlanetTagImg04}
                      width={253}
                      height={56}
                      alt="Tag 01"
                    ...
                    />
                    <Image
                      className="absolute left-5 bottom-24 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-25 transition-opacity duration-500"
                      src={PlanetTagImg05}
                      width={243}
                      height={56}
                      alt="Tag 03"
                    />
                    <Image
                      className="absolute -left-28 top-36 z-10 animate-[float_4s_ease-in-out_infinite_3s_both] opacity-80 transition-opacity duration-500"
                      src={PlanetTagImg01}
                      width={251}
                      height={56}
                      alt="Tag 04"
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                We choose our hosting and database providers carefully to ensure
                security and protection against threats. Where useful, we use a
                separate database provider for separation of concerns, which
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Your site is optimized for search engines and performance,
                ensuring that your content is discoverable and loads quickly for
                your visitors. We also use best practices to ensure your site
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                We never use WYSIWYG editors to build sites. We leverage the
                power of open source frameworks and component libraries. This
                gives us the flexibility to create custom solutions that meet
                your specific needs.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Our primary providers are all powered by green electricity, and
                we practice clean web design to reduce the carbon footprint of
                sites. Good does not have to compromise on these values.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
